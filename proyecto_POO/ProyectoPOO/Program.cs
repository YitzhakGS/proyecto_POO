        ...
        public static void MenuAdmin()
        {
            try
            {
                ...
                do
                {
                    ...
                    Console.WriteLine("\t-->Registrar Nuevo Empleado......(1)");
                    Console.WriteLine("\t-->Eliminar Empleado.............(2)");
                    ...
                    switch (op)
                    {
                        case 1:
                            ...
                            string nombreNuevoEmpleado = Console.ReadLine();
                            Console.WriteLine("Ingrese el área del nuevo empleado:");
                            string areaNuevoEmpleado = Console.ReadLine();
                            admin.AgregarEmpleado(nombreNuevoEmpleado, areaNuevoEmpleado);
                            break;
                        case 2:
